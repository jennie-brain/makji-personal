...
| SOM | 막지 자사몰 채널의 1년 차 목표 체계 | **6종 운영 검증 목표 2.1억 원 · 성장 목표 5.7억 원 · Stretch 9.9억 원** | [시장분석 10](10_PILOT_BASED_REVENUE_MODEL.md) |
...
flowchart TD
    ...
    D --> E["6종 운영 검증 목표<br/>2.1억 원"]
    D --> F["성장 목표<br/>5.7억 원 (0.22~0.27%)"]
...
|---|---:|---:|---|
| 단일상품 관측 기준선 | — | 0.30억 원 | 5월 파일럿의 상품 매출을 단순 연환산한 값 |
| 6종 기계적 기준선 | — | 1.80억 원 | 단일상품 파일럿 성과를 6개 상품에 동일 적용한 참고값 |
| 6종 운영 검증 목표 | 약 0.08~0.10% | 2.1억 원 | 상품구성·결제완결·객단가의 초기 개선을 확인하는 목표 |
| 성장 목표 | 0.22~0.27% | 5.7억 원 | 망넛이네의 런칭 초기 연도 매출을 참고한 목표 |
| Stretch | 0.37~0.47% | 9.9억 원 | 널담 초기 연도 매출에 준하는 도전 목표 |

5.7억 원과 9.9억 원은 각각 유사 성공 브랜드의 초기 실적을 참고한 값이다. 현재 파일럿과 6종 확장 기준선에서 얼마나 추가 성장이 필요한지의 계산은 [시장분석 10](10_PILOT_BASED_REVENUE_MODEL.md)에 기록한다.
