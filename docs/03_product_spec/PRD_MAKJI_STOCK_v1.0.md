...
| :---: | --- | --- | --- | --- |
| P1 | 기존 프리미엄 베이커리·이커머스는 정가+시즌 프로모션이 전부라, 소비자가 다음 날 다시 확인할 새로운 정보가 없고 재방문 유인이 없다 | 벤치마크 경쟁사 5곳(런던베이글뮤지엄·노티드·성심당·SPC·CJ더마켓) 중 가격 변동·시세를 콘텐츠로 쓰는 곳 **0/5 = 0%**(시장분석08 1절) | 시장분석08 1절 경쟁사 가치 선언 브리핑, RFP 발주 배경(`RFP_ANALYSIS.md` 1장 "정적 이커머스의 한계") | N1 재방문을 부르는 콘텐츠형 가격 경험 |
...
| --- | --- | --- |
| N1 재방문을 부르는 콘텐츠형 가격 경험 | 오전장·오후장 하루 2회 갱신으로 재방문 시 항상 새 정보 노출률 **100%** | 0/5(기존 경쟁사 중 가격을 콘텐츠로 쓰는 곳 없음) |
...
| :---: | --- | --- | :---: | --- | --- |
| **F-01** | 오전장·오후장 가격 확인(세션 상태 표시 포함) | FR-H01~03, FR-BM01~07 | **Must** | 경쟁사 0/5가 가격 변동을 콘텐츠로 쓰지 않음(P1) — 유일한 차별화 축의 기반 | 환율·검색량 데이터 API |
...
| --- | --- | --- |
| 기존 경쟁사 누구도 가격 변동을 콘텐츠·신뢰 요소로 쓰지 않는다(시장 Pain P1) | 시장분석01·08 경쟁사 5곳 실측 | 0/5 = 0% |
